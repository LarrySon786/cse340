...
async function getProductByInventoryId(inventory_id) {
  try {
    const data = await pool.query(
    ...
    console.error("getProductByInventoryId error " + error)
  }
}

// REGISTER CLASSIFICATION FROM ADD CLASSIFICATION SCREEN
...
// REGISTER NEW INVENTORY FROM ADD NEW INVENTORY SCREEN
...
module.exports = { getClassifications, getInventoryByClassificationId, getProductByInventoryId, registerClassification, checkClassificationExists, registerInventory};